...
const PRECAUTION_RULES: { match: PrecautionMatch; keywords: string[] }[] = [
  {
    match: {
      ...
      protocol: 'EBP',
      description: 'Recommended for residents with wounds or indwelling devices who receive high-contact care.',
      examples: ['Indwelling urinary catheter', 'Foley catheter', 'Tracheostomy', 'Central line'],
    },
    keywords: ['indwelling catheter', 'foley catheter', 'urinary catheter', 'central line', 'tracheostomy', 'ventilator'],
  },
  {
    match: {
      title: 'Contact Precautions',
      protocol: 'Contact',
      description: 'Use gown and gloves for direct contact or care of environment.',
      examples: ['C. diff', 'Clostridioides difficile', 'MRSA', 'VRE'],
    },
    keywords: ['c. diff', 'c diff', 'clostridioides difficile', 'mrsa', 'vre', 'mdro', 'esbl', 'norovirus'],
  },
  {
    match: {
